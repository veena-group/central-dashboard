...
export class MyFormsComponent {
  ...
  constructor() {
    this.load(0);
    this.api.listCategories('FORM').subscribe((categories) => this.categories.set(categories));
  ...
  load(page: number): void {
    ...
    this.api.listPaged<FormRow>('/forms', page, MyFormsComponent.PAGE_SIZE, {
  ...
  openAttachmentList(row: FormRow): void {
